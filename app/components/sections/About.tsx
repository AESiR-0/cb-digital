...
export default function About() {
  return (
    <div className="bg-primary   py-10">
      ...
      <div className={`flex flex-col gap-20 items-center p-8 rounded-lg shadow-lg rounded-xl `}>

        <div className={`flex flex-col items-center w-full max-w-[50vw] p-8 rounded-lg shadow-lg rounded-xl border border-white`}>
          <h1 className="text-5xl font- text-[#8f98ff] sm:text-4xl md:text-5xl py-8 font-clash text-white">
            What ?
          </h1>
          <div className="flex font-clash justify-center flex-wrap gap-4">
            {[
              ...
              <div
                key={index}
                className="px-4 py-2 hover:bg-[#7a5dc7] hover:text-white hover:cursor-pointer transition-all rounded-full border border-white text-sm md:text-lg font-medium"
              >
                {service}
              </div>
            ))}
