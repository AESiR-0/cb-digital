...
export default function CTA() {
  return (
    <div className="w-screen bg-secondary py-10 px-5 md:px-20 lg:px-40 flex items-center justify-between flex-col-reverse md:flex-row font-clash">
      ...
      <div className="flex flex-col items-start px-5 md:px-10 md:w-1/2 h-full text-center md:text-left font-bold">
      ...
      {/* Right Column: Image */}
      <div className="md:w-1/2 flex justify-center items-center pt-6 md:pt-0">
        <Image
