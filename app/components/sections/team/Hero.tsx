...
export default function Hero() {
  return (
    <div className="w-full h-[80vh] py-5 font-clash bg-primary flex flex-col lg:flex-row items-center justify-center gap-10 lg:gap-20 px-5 overflow-hidden">
      <div className="md:relative hidden  z-20 pt-10 lg:pt-0">
        <Card />
      </div>
      <div className="w-full max-w-lg lg:max-w-xl flex flex-col gap-6 lg:gap-8 h-full justify-center text-white text-center lg:text-left px-5 lg:px-20">
