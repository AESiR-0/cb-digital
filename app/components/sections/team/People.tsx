...
export default function Team() {
  return (
    <div className="w-full bg-[#00000] py-20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8  items-center">
              ...
              <div className="space-y-8">
                ...
                <p className="text-xl text-white/70 leading-relaxed">
                  I, along with my team at Team K, don't follow trends — we
                  create what others try to copy. We turn raw ideas into
                  scroll-stopping content, build formats from scratch, and scale
                  digital brands with intention. For us, it's not just about
                  going viral — it's about crafting content that lasts, engages,
                ...
                <div className="grid grid-cols-3 gap-8 pt-8 border-t border-white/10">
                  ...
                  >
                    ...
                    <div className="text-sm text-white/60 uppercase tracking-wider group-hover:text-red-400 transition-colors duration-300">
                      Twitter
                    </div>
                  </a>
