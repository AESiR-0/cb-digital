...
const brands: Brand[] = [
  {
    name: "PORTER",
    category: "LOGISTICS",
    videoUrl: "https://pratt-css.com/TeamK/porter.webm",
    activeColor: "from-blue-600/20 to-blue-800/20",
  },
  {
    name: "LITTLE JOYS",
    category: "KIDS WELLNESS",
    videoUrl: "https://pratt-css.com/TeamK/vfh2r6iyjwppj3vhbyt2.webm",
    activeColor: "from-purple-500/20 to-pink-500/20",
  },
  {
    name: "POCKET FM",
    category: "AUDIO ENTERTAINMENT",
    videoUrl: "https://pratt-css.com/TeamK/PocketFM.webm",
    activeColor: "from-orange-500/20 to-red-500/20",
  },
  {
    name: "GROWW",
    category: "INVESTMENT",
    videoUrl: "https://pratt-css.com/TeamK/groww.webm",
    activeColor: "from-green-500/20 to-emerald-500/20",
  },
  {
    name: "COP 28 UAE",
    category: "SUSTAINABILITY",
    videoUrl: "https://pratt-css.com/TeamK/cop_28.webm",
    activeColor: "from-teal-500/20 to-cyan-500/20",
  },
  {
    name: "NISSAN",
    category: "AUTOMOTIVE",
    videoUrl: "https://pratt-css.com/TeamK/Nissan.webm",
    activeColor: "from-red-600/20 to-red-800/20",
  },
  {
    name: "SUGARFIT",
    category: "FITNESS & WELLNESS",
    videoUrl: "https://pratt-css.com/TeamK/sugarfit.webm",
...
export default function BrandShowcase() {
  ...
  useEffect(() => {
    const currentIndex = brands.findIndex(
      (brand) => brand.name === activeBrand.name
    );
        ...
        <div className="w-full lg:w-1/3 ">
          {brands.map((brand) => (
            ...
            >
              ...
              <span className="text-sm pt-1 font-light  relative z-10">
                {brand.category}
              </span>
            </div>
          ))}
