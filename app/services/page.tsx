  ...
  return (
    <div className="w-screen bg-primary h-full">
      ...
      <TitleBody
        color="secondary"
        title="what we do"
        body={`We dive into your podcast, pull out the gold, and present it in a way that's impossible to scroll past. Our team is all about finding those mic-drop moments, the laughs, the feels, the wow-factor, and turning them into content that makes your audience hit the share button.`}
      />
      <div className="py-10">
        <HowWeDoIt />
      </div>
